...
<form action="<?php echo SITE_ROOT; ?>/users/save" method="post" name="adduser">
    ...
    <div><label class="fixedlabel" for="username">Username: </label><input type="text" value="<?php if(isset($user)){echo $user['username'];} ?>" name="username" required></div>
    ...
    <div><label class="fixedlabel" for="role">Role: </label><input type="text" value="<?php if(isset($user)){echo $user['role'];} ?>" name="role"></div>
    <div class="labelbtn">
