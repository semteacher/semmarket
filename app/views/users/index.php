    ...
    <section id="content">
        ...
        <?php if ($users): foreach ($users as $user): ?>
            ...
            <div>
                ...
                <span><a
                        href="<?php echo SITE_ROOT; ?>/users/edit/<?php echo $user->getIdUser(); ?>">Edit/View</a></span>
                <span><a href="<?php echo SITE_ROOT; ?>/users/changepassword/<?php echo $user->getIdUser(); ?>">Change Password</a></span>
                <span><a href="<?php echo SITE_ROOT; ?>/users/del/<?php echo $user->getIdUser(); ?>"
                         onclick="return confirm('Are you sure you want to delete?')">Delete</a></span>
            </div>
